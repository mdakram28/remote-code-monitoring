...
4. For Local machine
	...
	4.2. Run
		...
		4.2.2. Run './targetfile'
-------------------------------------------------------------------------------------------------------------------
5. For runnig example code on local machine
	5.1. Compile source code
		5.1.1. Run 'cd hda-server/example/sources/'
		5.1.2. Run 'compile fib.c -o ../target/fib'
	5.2 Run binary
		5.2.1. Run 'cd ../target'
		5.2.2. Run './fib'
-------------------------------------------------------------------------------------------------------------------